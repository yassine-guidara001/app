...
/// Page principale de réservation sans plan
class ReservationPage extends StatelessWidget {
            ...
            child: Center(
              child: ConstrainedBox(
                ...
                child: Container(
                  ...
                  child: _buildRemovedModuleState(),
                ),
              ),
            ),
          ),
  ...
  Widget _buildRemovedModuleState() {
      ...
      child: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              'Les vues 2D, 3D et l integration du plan ont ete retirees de cette page.',
